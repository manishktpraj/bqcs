...
<div class="avatar" style="border:1px solid #ddd;"><img src="<?php echo (isset($video->ins_logo) && $video->ins_logo!="")?SITE_UPLOAD_URL.SITE_INSTITUTE_IMAGE.$video->ins_logo:SITE_NO_IMAGE_PATH;?>" class="rounded"  alt=""></div>
