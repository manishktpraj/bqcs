...
<div class="avatar" style="border:1px solid #ddd;"><img src="<?php echo (isset($value->sm_image) && $value->sm_image!="")?SITE_UPLOAD_URL.SITE_STUDY_MATERIAL_IMAGE.$value->sm_image:SITE_NO_IMAGE_PATH;?>" class="rounded" alt=""></div>
...
<td><?php echo isset($value->ins_name)?$value->ins_name:'Admin';?></td>
