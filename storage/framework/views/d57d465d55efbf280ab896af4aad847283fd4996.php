...
th{padding:10px;background: #ccc;border: 1px solid #333;width:50%;font-family: 'Open Sans', sans-serif;}
...
<div class="imgboxlist">
                        ...
                        <?php foreach($quest_data as $img_name){?>
                            <li><a href="#">
                                <div class="imgbox">
                                    <img src="<?php echo $img_name->qa_value;?>"  style="width:150px;height:150px">
                                 </div>
                            </a>
                        </li>
                        <?php } ?>                         
