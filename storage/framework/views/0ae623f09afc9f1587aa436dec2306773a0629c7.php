...
<option value="<?php echo $role->role_name;?>" <?php echo (isset($resfacultyData->faculty_role) && $resfacultyData->faculty_role==$role->role_name)?'selected':''?>><?php echo $role->role_name;?></option>
<?php } ?>
</select>
</div>
</div>
...
<?php echo $__env->make('Csadmin.Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\xamp\htdocs\bpi\resources\views/Csadmin/Services/addNewFaculty.blade.php ENDPATH**/ ?>