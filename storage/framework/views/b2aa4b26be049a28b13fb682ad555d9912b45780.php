...
<ul>
<li class="<?php echo (isset($title) && $title == 'Manage Services' || $title == 'Question')?'active':''; ?>"><a href="<?php echo e(route('services')); ?>" >Manage Services</a></li>
<li class="<?php echo (isset($title) && $title == 'Add New Service')?'active':''; ?>"><a href="<?php echo e(route('add-new-service')); ?>" >Add New Service</a></li>
</ul>
</li>
