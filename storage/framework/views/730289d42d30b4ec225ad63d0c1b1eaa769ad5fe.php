...
<div class="avatar" style="border:1px solid #ddd;"><img src="<?php echo (isset($package->package_image) && $package->package_image!="")?SITE_UPLOAD_URL.SITE_PACKAGE_IMAGE.$package->package_image:SITE_NO_IMAGE_PATH;?>" class="rounded" alt=""></div>
