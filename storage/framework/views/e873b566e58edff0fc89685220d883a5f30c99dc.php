...
<div id="appCapsule">
    ...
    <div class="section full">  
        <div class="wide-block pt-2 pb-2">
            ...
            <div class="flex-class mb-1"><span  class="tx-16 mr-5"><ion-icon name="location-outline" style="margin-top: 3px;"></ion-icon></span> <span  class="tx-13"><?php echo e($value->customerAddress->customer_address); ?></span></div>
