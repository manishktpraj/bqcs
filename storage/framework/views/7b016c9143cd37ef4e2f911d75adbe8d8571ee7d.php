...
<h5 class="modal-title">Booking (Id: <?php echo e($popup[0]->ca_id); ?> )</h5>
<a href="#" id="ModalCommentdismiss" data-bs-dismiss="modal">Close</a>
</div>
<div class="modal-body">
<div class="booking-details">
<ul>
<li class="tx-14"><span class="mr-10"><ion-icon name="map"></ion-icon></span><span><?php echo e($popup[0]->customer_address); ?></span></li>
...
<li class="tx-14"><span class="mr-10"><ion-icon name="clipboard"></ion-icon></span><span><?php echo e($serData); ?></span></li>
...
<li class="tx-14"><span class="mr-10"><ion-icon name="person"></ion-icon></span><span><?php echo e($popup[0]->faculty_first_name); ?>  <?php echo e($popup[0]->faculty_last_name); ?></span></li>
</ul>
</div>
...
<li class="tx-14"><span class="mr-10"><ion-icon name="call"></ion-icon></span><span><a href="tel:<?php echo $popup[0]->customer_mobile;?>"><?php echo e($popup[0]->customer_mobile); ?></a></span></li>
<li class="tx-14"><span class="mr-10"><ion-icon name="mail"></ion-icon></span><span><a href="<?php echo $popup[0]->customer_email;?>"><?php echo e($popup[0]->customer_email); ?></a></span></li>
<li class="tx-14"><span class="mr-10"><ion-icon name="map"></ion-icon></span><span><?php echo e($popup[0]->customer_address); ?></span></li>
</ul>
</div>
...
<li class="tx-14"><span class="mr-10"><ion-icon name="clipboard"></ion-icon></span><span><?php echo e($serData1); ?></span></li>
...
<li class="tx-14"><span class="mr-10"><ion-icon name="person"></ion-icon></span><span><?php echo e($hist->faculty_first_name); ?>  <?php echo e($hist->faculty_last_name); ?></span></li>
 <?php }else{ ?>
...
</div><?php /**PATH D:\php\xamp\htdocs\bpi\resources\views/Pages/popupdetail.blade.php ENDPATH**/ ?>