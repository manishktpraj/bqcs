...
<option value="0" <?php  echo (isset($resPackageData->package_type) && $resPackageData->package_type=="0")?'selected':''?> id="test">Test</option>
<option value="1" <?php  echo (isset($resPackageData->package_type) && $resPackageData->package_type=="1")?'selected':''?> id="video">Video</option>
<option value="2" <?php  echo (isset($resPackageData->package_type) && $resPackageData->package_type=="2")?'selected':''?> id="testvideo">Test + Video</option>
<option value="3" <?php  echo (isset($resPackageData->package_type) && $resPackageData->package_type=="3")?'selected':''?> id="testvideopdf">Test + Video + Pdf</option>
</select>
</div>
</div> 
<div class="col-lg-6">
