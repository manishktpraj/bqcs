...
<td scope="row" ><?php echo $faculty->faculty_first_name.$faculty->faculty_last_name;?></td>
<td scope="row" style="text-align:center;width: 50px;"><input type="checkbox" id="selectAll" class="clsSelectSingle" name="pkd_pack_id[<?php echo $cnt; ?>]" style="vertical-align: middle;" value="<?php echo $faculty->faculty_id; ?>" <?php foreach($resAssignedData as $data){if($data->pkd_ref==$faculty->faculty_id){echo "checked";}}?> ></td></tr>
