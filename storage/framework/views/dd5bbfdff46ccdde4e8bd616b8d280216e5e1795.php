    ...
    <div class="modal-dialog modal-dialog-centered wd-sm-400" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pd-25">
                <form method="post" action="<?php echo e(route('addAppointmentProccess')); ?>" enctype="multipart/form-data">  
                <?php echo csrf_field(); ?> 
                <div>
...
</script><?php /**PATH D:\php\xamp\htdocs\bpi\resources\views/Csadmin/appointmentmodal.blade.php ENDPATH**/ ?>