<?php if($question->question_id==42){
        ...
        <?php if($question->question_id==67){
          $quest_data= $resQuestionData->where('qa_question_id',67)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3");
          $quest_data2= $resQuestionData->where('qa_question_id',67)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3_");
          $quest_data3= $resQuestionData->where('qa_question_id',67)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3__");
...
//print_r($qusAns);
       ...
       <div class="wide-block pt-2 pb-2">
        ...
        $quest_data= $resQuestionData->where('qa_question_id',74)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3");
        $quest_data2= $resQuestionData->where('qa_question_id',74)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3_");
        $quest_data3= $resQuestionData->where('qa_question_id',74)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3__");
        $quest_data4= $resQuestionData->where('qa_question_id',74)->where('qa_tech_id','=',$technicianId)->where('qa_type',"3___");
