    ...
    <div class="section full mt-1">
        <div class="section-title">
            <div>
                ...
                <div class="flex-class mb-1"><span  class="tx-16 mr-5"><ion-icon name="location-outline" style="margin-top: 3px;"></ion-icon></span> <span  class="tx-13">{{ $rowAppointmentsData->customerAddress->customer_address}}</span></div>
