...
<div id="appCapsule">
    <div class="section full mt-1">
        <div class="section-title">
            <div>
                <h5 class="fw700 tx-14" style="margin-bottom:5px">Booking ID:{{$rowAppointmentsData->ca_id}} | {{$serData}}</h5>
                <div class="flex-class mb-1"><span  class="tx-16 mr-5"><ion-icon name="location-outline" style="margin-top: 3px;"></ion-icon></span> <span  class="tx-13">{{ isset($rowAppointmentsData->customerAddress)?$rowAppointmentsData->customerAddress->customer_address:''}}</span></div>
...
{ ?>
      ...
      <div class="imgbox"  data-bs-toggle="modal"  data-bs-target="#ModalImage" data-id="<?php echo $img_name->qa_id;?>"  data-booking="{{$rowAppointmentsData->ca_id}}"
