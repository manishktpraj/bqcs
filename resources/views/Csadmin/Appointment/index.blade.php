...
<a href="{{route('statusChangeAppointment',$value->ca_id)}}"><span class="badge badge-success">Active</span></a>
<?php }else{?>
<a href="{{route('statusChangeAppointment',$value->ca_id)}}"><span class="badge badge-danger">Inactive</span></a>
<?php }?>
</td>
...
<a href="{{route('deleteAppointment',$value->ca_id)}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-icon mg-r-5" title="Delete" style="padding:0px 5px;"><i class="fas fa-trash-alt" style="font-size:11px;"></i></a>
</nav>
</div>
</td>
</tr>    
